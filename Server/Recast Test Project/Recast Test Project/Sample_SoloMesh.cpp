...
void Sample_SoloMesh::handleDebugMode()
{
	...
	if (unavail)
	{
		std::cout << "Tick 'Keep Itermediate Results'" << std::endl;
		std::cout << "to see more debug mode options." << std::endl;
	}
}
...
bool Sample_SoloMesh::handleBuild()
{
	...
	*/
	...
	if (!m_chf)
	{
		...
		std::cout << RC_LOG_ERROR << "buildNavigation: Out of memory 'chf'." << std::endl;
		return false;
	}
