...
namespace Footsteps {
	...
	public class CharacterFootsteps : MonoBehaviour {
        ...
        void Start() {
            ...
            surfacemanager = GameObject.FindWithTag("SurfaceManager").GetComponent<SurfaceManager>();
		...
		void PlayFootstep() {
			AudioClip randomFootstep = surfacemanager.GetFootstep(currentGroundInfo.collider, currentGroundInfo.point);
